...
public class Base64Util {
	...
	*/
	...
	public static char[] encodeToChar(String s) {
		try {
			return encodeToChar(s.getBytes(ENC), false);
	...
	*/
	...
	public static byte[] encodeToByte(String s) {
		try {
			return encodeToByte(s.getBytes(ENC), false);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	*/
	...
	public static String encodeToString(String s) { 
		try { 
			return new String(encodeToChar(s.getBytes(ENC), false)); 
		} catch (UnsupportedEncodingException ignore) { 
			return null; 
		} 
	} 
	...
	public static String decodeToString(String s) { 
		try { 
			return new String(decode(s), ENC); 
		} catch (UnsupportedEncodingException ignore) { 
			return null; 
		} 
	} 
